...
document.querySelector('.nav__links').addEventListener('click', function(e){
  ...
  if(e.target.classList.contains('nav__link')){
    ...
    id !== "#" && document.querySelector().scrollIntoView({behavior: 'smooth'});
  }
})
...
// const handleScrollSticky = function(){
...
// window.addEventListener('scroll', throttle(handleScrollSticky, 500))
...
const headObserver = new IntersectionObserver(stckyNav, {
  root: null,
  threshold: 0,
...
// remove the observer for improvement after once the section is visible
...
const loadImage = function(entries, observer){
  ...
  // Remove lazy class only when the high resolution image is completely loaded
